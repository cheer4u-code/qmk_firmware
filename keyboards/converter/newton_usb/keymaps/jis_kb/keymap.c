...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------|
     * |Ctrl  |Alt  |Gui  |      Space          |Lft|Rgt|Dn |Up  |
     * `---------------------------------------------------------'
     */
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_LEFT, KC_RGHT, KC_DOWN, KC_UP),
    /*
     * ,---------------------------------------------------------.
    ...
    [1] = LAYOUT(
        ...
        _______, KO_OFF,  KO_ON,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, QK_BOOT, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______,                            _______,                            KC_HOME, KC_END,  KC_PGDN, KC_PGUP),
};
// clang-format on
